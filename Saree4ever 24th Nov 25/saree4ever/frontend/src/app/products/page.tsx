...
async function getAllProducts(searchParams?: any): Promise<Product[]> {
  try {
    const filters: any = {};
    
    // Apply URL filters if provided (but don't force any filters)
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="heading-serif-md mb-2">All Products</h1>

...
CREATE INDEX IF NOT EXISTS idx_landing_page_videos_active ON landing_page_videos(is_active) WHERE is_active = true;
...
INSERT INTO landing_page_videos (video_url, is_active, autoplay, muted, loop) VALUES
(
  NULL,
  false,
  true,

        ...
        <div className="relative aspect-[3/4] overflow-hidden bg-white">
          ...
          <div className="absolute top-2 right-2 flex flex-col gap-2 z-10">
            ...
            <button
              ...
              className="bg-white/90 backdrop-blur-sm rounded-full p-2.5 sm:p-2 shadow-md hover:bg-white hover:shadow-lg transition-all touch-manipulation min-w-[40px] min-h-[40px] sm:min-w-[36px] sm:min-h-[36px] flex items-center justify-center"
              aria-label={isFav ? 'Remove from favorites' : 'Add to favorites'}
            >
              <svg
                className={`w-5 h-5 sm:w-5 sm:h-5 ${isFav ? 'fill-red-500 text-red-500' : 'text-gray-700'}`}
            ...
            <button
              ...
              className="bg-white/90 backdrop-blur-sm rounded-full p-2.5 sm:p-2 shadow-md hover:bg-white hover:shadow-lg transition-all disabled:opacity-50 touch-manipulation min-w-[40px] min-h-[40px] sm:min-w-[36px] sm:min-h-[36px] flex items-center justify-center"
      ...
      <div className="px-4 pb-4">
        <div className="flex gap-2">
          ...
          <button
            onClick={handleAddToCart}
            disabled={isAddingToCart}
            className="flex-1 btn-primary text-xs sm:text-sm min-h-[44px] h-auto py-2.5 flex items-center justify-center whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
          >

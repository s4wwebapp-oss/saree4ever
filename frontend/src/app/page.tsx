...
async function getQuickCategories(): Promise<QuickCategory[]> {
  ...
  const requiredCategories = [
    { name: 'Blouses', slug: 'blouses', image_url: 'https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?w=400&q=80' },
    { name: 'Jewels', slug: 'jewels', image_url: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&q=80' },
    { name: 'New Arrivals', slug: 'new-arrivals', image_url: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=400&q=80' },
    { name: 'Hot deals', slug: 'hot-deals', image_url: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=400&q=80' },
  ];
...
async function getComingSoonSettings(): Promise<{ is_enabled: boolean; title?: string; subtitle?: string }> {
  try {
    ...
    // Silently return disabled if table doesn't exist or other error
...
async function getComingSoonMedia(): Promise<ComingSoonMedia[]> {
  try {
    ...
    // Silently return empty array if table doesn't exist or other error
    return [];
  }
}

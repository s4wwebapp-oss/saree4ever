...
export default function AdminCategoriesPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/upload/category-image`, {
        method: 'POST',
        headers: {
      ...
      alert(errorMessage);
      console.error('Error uploading image:', err, 'URL:', `${process.env.NEXT_PUBLIC_API_URL}/uploads/category-image`);
    } finally {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <label className="btn-outline cursor-pointer text-sm py-1 px-3">
              ...
              {formData.image_url && (
                <img
                  ...
                  className="mt-2 h-20 w-20 object-cover border border-gray-300 rounded"
                />
              )}
            </div>
            <div>
